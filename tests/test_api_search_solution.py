...
class TestApiSearchSolution(object):
    ...
    def test_api_search_solution_002(self, server):
        ...
        ## Brief: Call GET /snippy/api/v1/solutions and search keywords from
        ##        all fields. The search query matches to three solutions but
        ##        limit defined in search query results only two of them
        ##        sorted by the brief field. The sorting must be applied
        ##        before limit is applied. The search is case insensitive
        ##        and the search keywords are stored with initial letters
        ##        capitalized when the search keys are all small letters.
        ##       The search keywords must still match.
        result_headers = {
            'content-type': 'application/vnd.api+json; charset=UTF-8',
            'content-length': '5258'
        }
    ...
    def test_api_search_solution_003(self, server):
        ...
        ## Brief: Call GET /snippy/api/v1/solutions and search keywords from
        ##        all fields. The search query matches to two solutions but
        ##        only one of them is returned because the limit parameter was
        ##        set to one. In this case the sort is descending and the last
        ##        match must be returned. The resulting fields are limited to
        ##        brief and category.
        result_headers = {
            'content-type': 'application/vnd.api+json; charset=UTF-8',
            'content-length': '175'
    ...
    def test_api_search_solution_005(self, server):
        ...
        ##        all fields. The search query matches to three solutions but
        ##        limit defined in search query results only two of them
        ##        sorted by the utc field in descending order and then based
        ##        on brief field in descending order.
        result_headers = {
            'content-type': 'application/vnd.api+json; charset=UTF-8',
            'content-length': '7468'
        }
    ...
    def test_api_search_solution_006(self, server):
        ...
        ## Brief: Call GET /snippy/api/v1/solutions and search keywords from
        ##        all fields sorted with two fields. This syntax that
        ##        separates the sorted fields causes the parameter to be
        ##        processed in string context which must handle multiple
        ##        fields.
        result_headers = {
    ...
    def test_api_search_solution_007(self, server):
        ...
        ##        set to field name that is not existing. The sort must fall to
        ##        default sorting.
        result_headers = {
            'content-type': 'application/vnd.api+json; charset=UTF-8',
            'content-length': '380'
    ...
    def test_api_search_solution_008(self, server):
        ...
        ##        fields. In this case the fields are defined by setting the
    ...
    def test_api_search_solution_009(self, server):
        ...
        ##        keywords that do not result any results.
        result_headers = {
            'content-type': 'application/vnd.api+json; charset=UTF-8',
            'content-length': '335'
        }
    ...
    def test_api_search_solution_012(self, server):
        ...
        ##        solution based on digest. In this case the solution is
        ##        found.
        result_headers = {
            'content-type': 'application/vnd.api+json; charset=UTF-8',
            'content-length': '2451'
    ...
    def test_api_search_solution_014(self, server):
        ...
        result_headers = {'content-type': 'application/vnd.api+json; charset=UTF-8', 'content-length': '5258'}
        result_json = {
            'data': [{
                'type': 'solutions',
                'id': 'a96accc25dd23ac0554032e25d773f3931d70b1d986664b13059e5e803df6da8',
    ...
    def test_api_search_solution_015(self, server):
        ...
        ## Brief: Call GET /snippy/api/v1/solutions without defining search
        ##        parameters. In this case only one solution must be returned
        ##        because the limit is set to one. Also the sorting based on
        ##        brief field causes the last solution to be returned.
        result_headers = {
            'content-type': 'application/vnd.api+json; charset=UTF-8',
            'content-length': '2905'
        }
