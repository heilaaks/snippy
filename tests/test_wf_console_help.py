...
class TestWfConsoleHelp(unittest.TestCase):
    ...
    def test_console_help(self):
        ...
        with mock.patch('snippy.config.arguments.argparse.ArgumentParser.exit') as mocked_exit:
            ...
            assert mocked_exit.call_count == 2
...
#    #@mock.patch('sys.exit')
#    def test_console_help_examples(self, mocked_exit):
#        """Test getting help from consoler."""
#
#        #with mock.patch('snippy.config.arguments.argparse.ArgumentParser.exit') as mocked_exit:
#        #with mock.patch('snippy.config.arguments.sys.exit') as mocked_exit:
#        with mock.patch('snippy.config.arguments.argparse.ArgumentParser.exit') as mocked_exit:
#        #with self.assertRaises(SystemExit):
#            output = ('    Creating new content:',
